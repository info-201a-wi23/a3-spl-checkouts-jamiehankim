...
# Chart 2
chart3_df <- spl_df %>% filter(CheckoutYear == "2022") %>% 
...
ggplot(chart3_df) + 
  geom_col(mapping = aes(
    ...
    y = total_checkouts, 
    fill = MaterialType)) + 
  labs(title = "Total Number of Checkouts For Each Types of Book in 2022", x = "Material Type", y = "Number of Total", color = "MaterialType") + 
